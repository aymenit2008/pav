...
def execute(filters=None):
	...
	res, currency_list = get_result(filters, account_details)

	columns = get_columns(filters,currency_list)
	#frappe.msgprint("filters=========={0},account_details=========={1},res=========={2}".format(filters,account_details,res))
	return columns, res
